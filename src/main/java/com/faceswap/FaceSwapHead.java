...
{
	GNOMONKEY("Gnomonkey", FaceSwapHeadCategory.CONTENT_CREATOR, true, true),
	ODABLOCK("Odablock", FaceSwapHeadCategory.CONTENT_CREATOR, true, true),
	...
	MINT_MADCOW("MintMadCow", FaceSwapHeadCategory.CONTENT_CREATOR, true, true),
	...
	BRETTDOG("Brett Dog", FaceSwapHeadCategory.CONTENT_CREATOR, true, true),
	MMORPG("MMORPG", FaceSwapHeadCategory.CONTENT_CREATOR, true, true),
	JOSH_PILLAUT("The RS Felon", FaceSwapHeadCategory.CONTENT_CREATOR, true, true),
	...
	MINT_MADCOW_OSRS("MintMadCow (OSRS)", FaceSwapHeadCategory.CONTENT_CREATOR_3D, true, true),
	...
	BRETTDOG_OSRS("Brett Dog (OSRS)", FaceSwapHeadCategory.CONTENT_CREATOR_3D, true, true),
	MMORPG_OSRS("MMORPG (OSRS)", FaceSwapHeadCategory.CONTENT_CREATOR_3D, true, true),
	JOSH_PILLAUT_OSRS("The RS Felon (OSRS)", FaceSwapHeadCategory.CONTENT_CREATOR_3D, true, true),
	MRNOSLEEP_OSRS("Mr Nosleep (OSRS)", FaceSwapHeadCategory.CONTENT_CREATOR_3D, true, true),
	SICK_NERD_OSRS("Sick Nerd (OSRS)", FaceSwapHeadCategory.CONTENT_CREATOR_3D, true, true),
	...
	MONKEY_PHOTO("Monkey", FaceSwapHeadCategory.FICTIONAL_CHARACTER, true, true),
	...
	PEPE("Pepe", FaceSwapHeadCategory.FICTIONAL_CHARACTER, true, true),
	JD_VANCE("JD Vance", FaceSwapHeadCategory.FICTIONAL_CHARACTER, true, true),
	...
	FaceSwapHead getOsrsVariant()
	{
		switch (this)
		{
			...
			case ASIAN_ANDY: return ASIAN_ANDY_OSRS;
			case MINT_MADCOW: return MINT_MADCOW_OSRS;
			case ALFIE: return ALFIE_OSRS;
			case BEGGAR: return BEGGAR_OSRS;
			case DEARLOLA: return DEARLOLA_OSRS;
			case GRIM: return GRIM_OSRS;
			case KING_CONDOR: return KING_CONDOR_OSRS;
			case PRISONJOE: return PRISONJOE_OSRS;
			case TPAPASLICE: return TPAPASLICE_OSRS;
			case ZECOOKIES: return ZECOOKIES_OSRS;
			case ELIOP14: return ELIOP14_OSRS;
			case JILLYFISH: return JILLYFISH_OSRS;
			case SKILL_SPECS: return SKILL_SPECS_OSRS;
			case TASTYLIFE: return TASTYLIFE_OSRS;
			case BRETTDOG: return BRETTDOG_OSRS;
			case MMORPG: return MMORPG_OSRS;
			case JOSH_PILLAUT: return JOSH_PILLAUT_OSRS;
			case MRNOSLEEP: return MRNOSLEEP_OSRS;
			case SICK_NERD: return SICK_NERD_OSRS;
			default: return null;
		}
	}

	FaceSwapHead getBaseVariant()
		{
			switch (this)
		{
			...
			case SARDACO_OSRS: return SARDACO;
			case ASIAN_ANDY_OSRS: return ASIAN_ANDY;
			case MINT_MADCOW_OSRS: return MINT_MADCOW;
			case ALFIE_OSRS: return ALFIE;
			case BEGGAR_OSRS: return BEGGAR;
			case DEARLOLA_OSRS: return DEARLOLA;
			case GRIM_OSRS: return GRIM;
			case KING_CONDOR_OSRS: return KING_CONDOR;
			case PRISONJOE_OSRS: return PRISONJOE;
			case TPAPASLICE_OSRS: return TPAPASLICE;
			case ZECOOKIES_OSRS: return ZECOOKIES;
			case ELIOP14_OSRS: return ELIOP14;
			case JILLYFISH_OSRS: return JILLYFISH;
			case SKILL_SPECS_OSRS: return SKILL_SPECS;
			case TASTYLIFE_OSRS: return TASTYLIFE;
			case BRETTDOG_OSRS: return BRETTDOG;
			case MMORPG_OSRS: return MMORPG;
			case JOSH_PILLAUT_OSRS: return JOSH_PILLAUT;
			case MRNOSLEEP_OSRS: return MRNOSLEEP;
			case SICK_NERD_OSRS: return SICK_NERD;
			default: return null;
		}
	}
