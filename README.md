...
- Pick from a selection of your favorite content creators with various expressions
...
- **MintMadCow:** [Kick](https://kick.com/mintmadcow) | [YouTube](https://www.youtube.com/@MintMadcow) | [Twitch](https://www.twitch.tv/mintmadcow)
- **Brett Dog:** [Twitch](https://www.twitch.tv/brettdog_) | [X](https://x.com/Brettdog_)
- **MMORPG:** [Kick](https://kick.com/mmorpg-rs) | [YouTube](https://www.youtube.com/@mmorpgrs) | [Twitch](https://www.twitch.tv/mmorpg) | [X](https://x.com/MmorpgCP)
...
- Non-humanoid NPCs, pets, and some enemies can render with stretched geometry, misplaced heads, or incorrect mask placement
- Multi-head NPCs and bosses, such as the King Black Dragon, are not yet supported correctly in `3D` mode
- Different custom face pairs assigned to specific players appear together in the same `Specific Players` list, although each player retains their individual pair assignment
